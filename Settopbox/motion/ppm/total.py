...
def main(start_stretch=False,is_letter=False):
    # manager = Manager()
    ...
    def render_overlay(engine, output, src_size, inference_box):
        ...
        nonlocal sms_url, n, sum_process_time, sum_inference_time, fps_counter, cnt, before_nose, timer_time, move_camera, turn_cnt
